...
| `revertColumnSize(current, base, columnId)`                          | `ColumnSizingState`              | The sizing state with columnId reverted to its width in base — or omitted entirely if base had none — for Escape to restore.        |
